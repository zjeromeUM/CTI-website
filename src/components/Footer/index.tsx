...
const Footer = () => {
  ...
  <footer className="relative z-10 bg-white pt-16 md:pt-20 lg:pt-24">
        <div className="container">
          ...
          <div className="py-8">
            <p className="font-poppins font-bold italic text-center text-base text-[#02a9f7]">
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#88d6fa" stopOpacity="0.62" />
                <stop offset="1" stopColor="#88d6fa" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#88d6fa" stopOpacity="0" />
                <stop offset="1" stopColor="#88d6fa" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
